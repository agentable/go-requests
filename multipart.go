...
type FilePart struct {
	...
	Filename    string
	ContentType string
	Body        io.Reader // Body is borrowed and is never closed by requests.
}
...
// Replayable buffers the multipart body up to maxBytes for retries and body-preserving redirects.
